...
public class agus {
    public static void main(String[] args) {
        Scanner student = new Scanner(System.in); //ubah pilihan sesuai dengan yang kalian mau
        boolean sudah = false; //ini juga ubah variabel selesai nya
        ...
        while (!sudah) {
            ...
            int suara = student.nextInt(); //ubah choice sesuai yang kalian mau
